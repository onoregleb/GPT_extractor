...
#os.environ["OPENAI_API_KEY"] = "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"
response = Document()
...
def generate_response(uploaded_file, employees_info, project_name, num_employees):
    if uploaded_file is not None:
        ...
        titles = ["Команда", "Аннотация к проекту", "Какой продукт или услуга будет продаваться",
                  ...
                  "Перечень планируемых работ - этап 1", "Перечень планируемых работ - этап 2",
                  "Коллектив - данный момент", "Техническое оснащение - данный момент",
                  "Партнеры (поставщики, продавцы) - переговоры на данный момент",
